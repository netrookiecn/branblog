...
* 问道/大搜自然语言增强/火车票筛选项识别：对比不同模型gpt3.5/4、baichuan1/2、llama1/2的评测，通过continue pretrain、sft方式增强关键信息抽取能力，F1平均高于95%， 基于vllm/fastllm部署
* 问道旅游对话助手：基于LIMA、Context Distiiling等方式，解决大模型角色认知等能力；基于数学、构造日期推理数据集等优化模型日期推理能力；基于rlhf优化常见开放域badcase
